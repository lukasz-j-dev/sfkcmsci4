	...
	<div class="container" style="background-color:white;">
					...
					<table style="width: 100%;">
						<tr>
							...
							<td style="width:43%;padding-right: 48px;%!important;">
								<p class="automated-stop-sign">STOP SIGN WARNING</p>
								<div class="top-notice">
									<div class="notice">
										<table style="width: 100%;max-width: 350px;">
											...
											<tr>
												<td><span>Warning Number:</td><td>' . $violation_details['violation_number'] . '</td>
											</tr>
											<tr>
		...
		<div class="row">
				<div class="col-md-4">
					<div class="notice-box">
						<div class="name">
							...
							' . $vio_address . '<br />
							' . $violation_details['vil_city'] . ', ' . $violation_details['vil_state'] . ' ' . $violation_details['vil_zip'] . '</p>
						</div>
				</div>
			</div>
			<!--notice-box-->
			...
			<div class="you-must-pay">
				<p class="youmust">NO PAYMENT IS REQUIRED</p>
				<div class="finedate" >
						<p class="date-main"><span class="mn_fine_amount">$' . $violation_details['violation_fine_amount'] . '</span></p>
					</div>
				<p class="carddetails" style="text-align:left;margin-bottom:1%!important;"><span style="margin-left:1%!important;margin-bottom:1%!important;">VISIT STOPFORKIDS.COM</span></p>
			</div>
			</div>
            <div>
				<img src="images/warning-stamp.svg" class="img_stamp" />
			</div>
		</div><!--row-->
	</div><!--End of headercode-->
	<div class="clearfix"></div>
	<div class="failure">Failure to stop at a traffic signal - no points - this is a warning only, no payment is required</div>
	<div class="violations">
	<table class="violation-info-table">
		<tbody>
			<tr>
				<td class="title-violation1">WARNING</td>
	...
	<div class="evidence"> 
		<div class="row">
			...
			<div class="col-md-4 vio-info padding-8">
				...
				<p style="vertical-align:middle;" class="vio-details"><span class="count-of-violation-info-src">3</span>NO PAYMENT IS DUE</p>
			</div>
            </div>
			<div class="col-md-4 points-to-assess padding-0 ">
				<div class="scan_qr">
					...
					<p class="qr_text" style="margin-top: -5px; transform: translateY(10px);">Scan QR code to view warning.</p>
				</div>
			</div>
		</div>
		...
		<div class="clearfix"></div>
		   <div class="evidence-info">
			<p class="info-about-evidence" style="margin-bottom: 5px;">This warning notice was issued to notify you that the vehicle identified above failed to stop at the stop sign. <b>There is NO FINE or APPEARANCE for this notice</b>. This warning is a courtesy extended to you by the ' . $violation_details['municipality_id_text'] . '. Please bear in mind that just having the brake lights on or slowing down is not ground for dismissal. The law requires vehicles to make a full stop before the stop sign. Please be mindful of this to avoid future violations. No action or payment is required for this warning. If you believe the license plate displayed in the photo and video above is not registered to you, please dispute online or contact ' . $violation_details['municipality_id_text'] . ' at ' . $violation_details['village_email'] . '.</p>
			</div>
	</div>
	<!--End of evedence-->
