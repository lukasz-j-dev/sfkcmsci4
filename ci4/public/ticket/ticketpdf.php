...
<div class="container" style="background-color:white;">
    <div class="header">
                <div class="row">
                        <div class="col-md-12 logoimg"><img class="logo" src="images/logo-new.jpg" style="padding-left:5px;">
                            <p class="automated-stop-sign">AUTOMATED STOP SIGN ENFORCEMENT VIOLATION</p>

                            <p class="village-of-great-neck">VILLAGE OF GREAT NECK</p>

                            <p class="baker-hill-road">61 BAKER HILL ROAD &bull; GREAT NECK,11023</p>
                            <p class="video-url">VIDEOENFORCEMENT.COM</p>
                        </div>
                </div>
    </div><!--end of header-->
    ...
    <div class="row">
            <div class="col-md-4">
                <div class="notice-box">
                    <div class="notice">
                        <p class="notice-date"><span>Notice Date:</span> Oct 06 2019</p>

                        <p class="violation-number"><span>Violation Number:</span> 1910060000</p>

                        <p class="pin-number"><span>Pin Number:</span> 883</p>
                    </div>
                    <div class="name">
                        <p class="address">JOHN DOE<br />
                        123 SAMPLE AVE<br />
                        NEW YORK, NY 11023</p>
                    </div>
            </div>
        ...
        <div class="col-md-4">
            <div class="qr-code" style="margin-top:15px";>
                <img class="qrcode" src="images/scan-new.jpg" width="100"/>
                <p class="scanqr">Scan code with your mobile<br />
                camera to view &amp; pay ticket online.</p>
            </div>
        </div>
        <!--qr-code-->
        ...
        <div class="you-must-pay">
            <p class="youmust" style="margin-bottom:1.5%!important;margin-top:2px!important;text-align:center!important;">YOU MUST PAY OR CONTEST BY <img class="arrow" src="images/arrow.jpg" width="21" height="25" /></p>
            &nbsp;

            <div class="finedate" >
                    <p class="date-main">FEB 23 2020<br>
                    $50.00</p>

                    <p class="visit">VISIT VIDEOENFORCEMENT.COM/PAY</p>
                </div>
...
<div class="evidence"> 
    <div class="row">
        <div class="col-md-4 eve-img padding-0">
            <div class="evidence-image"><img class="evidenceimg" src="images/12080180.png"></div>
        </div>
        ...
        <div class="col-md-4 vio-info padding-8">
            ...
            <p style="vertical-align:middle;" class="vio-details"><span class="count-of-violation-info-src">1</span>VIDEOENFORCEMENT.COM</p>
            <p style="vertical-align:middle;" class="vio-details"><span class="count-of-violation-info-src">2</span>ENTER<span class="second-violation-info" style="padding:0; vertical-align:middle; margin:0;"> 1910060000-883</span></p>
        ...
        <div class="col-md-4 points-to-assess padding-0 ">
            <div class="points">
                <p class="points-will-be-note">Points will not be assessed against the<br>
                registered owner or the designated driver <br>for this violation.</p>
            </div>
        </div>
    </div>
...
<div class="stubBymail" style="position:relative; clear:both;display:inline-block;width:100%; ">
 <div class="row">
                    ...
                    <div class="col-md-4 stub" style="display:inline-block;width:31%!important;position:relative;text-align:left;">
                        <p class="stub-no" style="vertical-align:middle;">1910060000-883</p>
                    </div>
                <div class="col-md-4 notice-date-info" style="display:inline-block;width:33.33%!important;position:relative;">
                    <div class="main-div-of-notice-info row">
                        <ul class="more-info-about-notice">
                            <li class="notice-date-info"><span class="Date-notice">Notice Date:</span> <span class="noticeDate newdate3" style="font-family:Arial-BoldMT; font-size:12px;">10/6/2019</span></li>
                            <li class="notice-date-info"><span class="Date-notice">Violation:</span> <span class="noticeDate2 violation-notice-number newdate3">1910060000-883</span></li>
                        </ul>
                    </div>
                </div>
</div>
...
<div class="row">
                    ...
                    <div class="col-md-4 due-date-section" style="float:right;width:33.33%!important;position:relative;">
                            ...
                            <div class="due-date-fine-amount">
                                    <p class="price-bottom">$50.00</p>

                                    <p style="margin-top:-10px;" class="second-row-of-due-date"><span style="padding-right:15px;">DUE DATE </span><span>FEB 2020</span></p>
                            </div>
                    </div>
...
<div class="third-section-of-footer row" style="position:relative;  clear:both;display: inline-block;width:100%;">
                ...
                <table class="footer-notice-info table" width="65%">
                    <tbody>
                        <tr>
                            ...
                            <td class="title-violation">DATE</td>
                        </tr>
                        <tr>
                            <td>1910060000</td>
                            <td>HKV3140</td>
    ...
    <div class="col-md-4 payable-check-info" style="float:left;width:33.33%;position:relative;">
        ...
        <span class="chq-payable">VILLAGE OF GREAT NECK</span></p>

        <p class="chq-payable" style="padding-top:15px;">P.O. BOX 2222<br />
...
<div class="col-md-12 fourth-section-of-div" style="position:relative;  clear:both;display:block; width:100%;">
    <div class="col-md-8 video-and-imginfo payment-intructions" style="float:left;width:50%;position:relative; margin-top:-10px;">
            ...
            CARD NOW AT VIDEOENFORCEMENT.COM/PAY <img class="creditcard-img" src="images/card-svg1.svg" width="160" style="display:inline-block;margin-left:85%!important;margin-top:-20px!important;"/></p>
