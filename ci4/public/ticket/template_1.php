			...
			<div class="row">
				...
				<div class="col-md-4 vio-info padding-8">
					<div class="violation-info">
						...
						<p style="text-align:center; padding:0; margin:0;"><img class="credit-cards" src="images/card-svg1.svg" width="180" /></p>
					</div>
				</div>
