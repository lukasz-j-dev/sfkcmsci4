...
if(!empty($_REQUEST['violation_id'])){
	...
	*, *:before, *:after {
	...
	if(count($violations_details) > 0){
		...
		foreach($violations_details as $violation_details){
			...
			$html .= '
				<div class="header">
							<div class="row">
									<div class="col-md-12 logoimg"><div style="height: 0; text-align: left;"><img class="logo" src="../cms/public/images/villages/' . $violation_details['municipality_logo'] . '" style="padding-left:5px;"></div>
										<div>
				...
				<div class="row">
						<div class="col-md-4">
							<div class="notice-box">
								<div class="notice">
									<p class="notice-date"><span>Notice Date:</span> ' . strtoupper(str_replace('-', ' ', $violation_details['notice_date'])) . '</p>
					...
					<div class="col-md-4">
						<div class="qr-code" style="margin-top:15px";>
							<!--<img class="qrcode" src="' . $qr_url . '" width="100"/> -->
							<p class="scanqr" style="color: #fff;">Scan code with your mobile<br />
					...
					<div class="you-must-pay">
						...
						<div class="finedate" >
								<p class="date-main">' . strtoupper(str_replace('-', ' ', $violation_details['due_date'])) . '<br>
			...
			<table class="violation-info-table">
				<tbody>
					...
					<tr>
						...
						<td>' . strtoupper(str_replace('-', ' ', $violation_details['violation_date'])) . '</td>
							...
							<div class="col-md-4 notice-date-info" style="display:inline-block;width:33.33%!important;position:relative;">
								<div class="main-div-of-notice-info row">
									<ul class="more-info-about-notice">
										<li class="notice-date-info"><span class="Date-notice">Notice Date:</span> <span class="noticeDate newdate3" style="font-family:Arial-BoldMT; font-size:12px;">' . strtoupper(str_replace('-', ' ', $violation_details['notice_date'])) . '</span></li>
			...
			<div class="row">
								...
								<div class="col-md-4 due-date-section" style="float:right;width:33.33%!important;position:relative;">
										...
										<div class="due-date-fine-amount">
												...
												<p style="margin-top:-10px;" class="second-row-of-due-date"><span style="padding-right:15px;">DUE DATE </span><span>' . strtoupper(str_replace('-', ' ', $violation_details['due_date'])) . '</span></p>
										</div>
								</div>
							...
							<table class="footer-notice-info table" width="65%">
								<tbody>
									...
									<tr>
										...
										<td style="width: 90px;">' . strtoupper(str_replace('-', ' ', $violation_details['violation_date'])) . '</td>
									</tr>
								</tbody>
							</table>
						</div>
			...
			<div class="col-md-12 fourth-section-of-div" style="position:relative;  clear:both;display:block; width:100%;">
				<div class="col-md-8 video-and-imginfo payment-intructions" style="float:left;width:50%;position:relative; margin-top:-10px;">
						...
						CARD NOW AT STOPFORKIDS.COM/PAY';
				if($cnt == 0) $html .= '<img class="creditcard-img" src="images/card-svg1.svg" width="160"/>';
				else $html .= '<img class="creditcard-img" src="images/card-svg1.svg" width="160"/>';
					$html .= '</p>
	...
	$html .= '</div><!--End of container-->
			<div class="clearfix"></div><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script><script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.0/js/bootstrap.min.js"></script></body>

	</html>';

	//echo $html;
	//exit;
	$filename = 'Violation-' . $violation_details['camera_zip'] . '-'. $violation_details['violation_number'] . '-' . $violation_details['violation_pin'];
