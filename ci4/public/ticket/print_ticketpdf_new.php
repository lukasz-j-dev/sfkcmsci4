		...
		<div class="container" style="background-color:white;">
			<div class="header">
				<div class="row">
					...
					<div class="col-md-4 domain">STOPFORKIDS.COM</div>
				</div>
				<div class="row" style="height: 100%; padding-bottom: 15px; padding-top: 4px;">
					<div class="col-md-2" style="text-align: center;">
						<img class="logo" src="../public/images/villages/logo.png" style="width: 50px; margin-left: 26px;">
					</div>
					<div class="col-md-5">
				...
				<div class="row">
					<div class="col-md-4">
						<div class="notice-box">
							<div class="notice">
								<p class="notice-date"><span>Notice Date:</span> ' . $notice_date . '</p>
	
								<p class="violation-number"><span>Violation Number:</span> ' .
									$violation_details['violation_number'] . '</p>
	
								<p class="pin-number"><span>Pin Number:</span> ' . $violation_details['violation_pin'] . '</p>
							</div>
							<div class="name">
								<p class="address">' . $violation_details['full_name'] . '<br />
									' . $vio_address . '<br />
									' . $violation_details['city'] . ', ' . $violation_details['state'] . ' ' .
									$violation_details['zip'] . '</p>
							</div>
						</div>
					</div>
					<!--notice-box-->
					...
					<div class="col-md-4">
						<div class="you-must-pay">
							&nbsp;
							<p class="youmust"
								style="margin-bottom:1.5%!important;margin-top:2px!important;text-align:center!important;">
								YOU MUST PAY OR CONTEST BY</p>
							<div class="finedate">
							...
							<p class="carddetails" style="text-align:left;margin-bottom:1%!important;"><span
									style="margin-left:1%!important;margin-bottom:1%!important;">Payment can be made online
									by credit card or debit card.</span><span><img class="creditcard-images"
										src="images/card-svg1.svg" width="94px" style="margin-left:9px;"></span></p>
						</div>
					</div>
				</div>
				<!--row-->
				...
				<table class="violation-info-table">
					<tbody>
						<tr>
							...
							<td class="title-violation1">TYPE</td>
							<td class="title-violation1">DATE</td>
							<td class="title-violation1">TIME</td>
						...
						<tr>
							...
							<td>' . $violation_details['violation_time'] . '</td>
							<td>STOP SIGN</td>
							<td>' . $violation_details['scene_location'] . '-' . $violation_details['camera_zip'] . '</td>
						</tr>
					</tbody>
				</table>
			</div>
			...
			<div class="evidence">
				<div class="row">
					<div class="col-md-4 eve-img padding-0">
						<div class="evidence-image"><img class="evidenceimg"
								src="data:image/png;base64, ' . $violation_photo_url . '"></div>
					</div>
					...
					<div class="col-md-4 vio-info padding-8">
						<div class="violation-info">
							...
							<p style="vertical-align:middle;" class="vio-details"><span
									class="count-of-violation-info-src">1</span>STOPFORKIDS.COM</p>
							<p style="vertical-align:middle;" class="vio-details"><span
									class="count-of-violation-info-src">2</span>ENTER<span class="second-violation-info"
									style="padding:0; vertical-align:middle; margin:0;"> ' .
									$violation_details['violation_number'] . '-' . $violation_details['violation_pin'] . '</span></p>
							<p style="vertical-align:middle;" class="vio-details"><span
									class="count-of-violation-info-src">3</span>PAY OR CONTEST TICKET</p>
							<p style="text-align:center; padding:0; margin:0;"><img class="credit-cards"
									src="images/card-svg1.svg" width="180" /></p>
						</div>
					</div>
				...
				<div class="evidence-info">
					<p class="info-about-evidence" style="margin-bottom: 15px;">These recorded images and videos are
						evidence of a violation of failure to stop at a stop sign. Please note, the vehicle identified above
						bears a license plate registered or leased in your name. All registered owners are legally
						responsible for this violation. If you believe the license plate displayed in the photo above is not
						registered to you, please contact Village of Saddle Rock at info@saddlerockny.gov</p>
				</div>
				<div class="clearfix"></div>
				<div class="row">
				...
				<div class="row">
					<div class="paying-or-contesting">
						<p><span>PAYING OR CONTESTING BY MAIL:</span> TO ENSURE PROPER CREDIT PLEASE RETURN THIS STUB WITH
							YOUR PAYMENT.</p>
					</div>
				</div>
				<div class="clearfix"></div>
				...
				<div class="main-class-notice-of-stub">
					<div class="stubBymail" style="position:relative; clear:both;display:inline-block;width:100%; ">
						<div class="row">
							<div class="col-md-4 stub-notice"
								style="display:inline-block;width:35%!important;position:relative;">
								<p>NOTICE OF VIOLATION STUB BY MAIL</p>
							</div>
	
							<div class="col-md-4 stub"
								style="display:inline-block;width:31%!important;position:relative;text-align:left;">
								<p class="stub-no" style="vertical-align:middle;">' . $violation_details['violation_number']
									. '-' . $violation_details['violation_pin'] . '</p>
							</div>
							<div class="col-md-4 notice-date-info"
								style="display:inline-block;width:33.33%!important;position:relative;">
								<div class="main-div-of-notice-info row">
									<ul class="more-info-about-notice">
										<li class="notice-date-info"><span class="Date-notice">Notice Date:</span> <span
												class="noticeDate newdate3"
												style="font-family:Arial-BoldMT; font-size:12px;">' . $notice_date .
												'</span></li>
										<li class="notice-date-info"><span class="Date-notice">Violation:</span> <span
												class="noticeDate2 violation-notice-number newdate3">' .
												$violation_details['violation_number'] . '-' . $violation_details['violation_pin'] .
												'</span></li>
									</ul>
								</div>
							</div>
					...
					<div class="second-section" style="margin-top:-20px!important;">
						<div class="row" style="position:relative; clear:both;display:inline-block;width:100%; ">
							<div class="col-md-8 pay" style="display:inline-block;width:60%!important;position:relative;">
								<div class="row">
									<div class="col-md-8 payment-options padding-right0"
										style="float:left;width:70.66%!important;position:relative;">
										<p style="margin:0;">Please fill in the <span class="pay-main">PAY</span> circle if
											you would like to pay this ticket by check</p>
	
										<p style="padding-top:10px; margin:0;"><span class="pay-main">OR</span></p>
	
										<p style="padding-top:10px; margin:0;">You may choose to contest and request a <span
												class="pay-main">in-person hearing</span></p>
									</div>
	
									<div class="col-md-4 various-payment-methods" style="float:left;width:29%!important;">
										<p class="pay-by-circle" style="float:left;text-align:center;"><span
												style="padding-left:10px; position:relative; left:15px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;PAY</span>
											<span class="right-arrow-image"
												style="padding-top:5px; padding-left:0; display: inline-block;margin-left:0%;"><img
													src="images/Arrow.svg" width="11px" style="padding-top:2px;"><img
													style="padding-left:3px;" src="images/Oval.svg" width="10px" /></span>
										</p>
	
										<p class="in-person"
											style="float:left!important;text-align:left;margin-top:13%!important;">
											<span>REQUEST ONLINE<br />
												HEARING DATE</span> <span class="right-arrow-image2"
												style="display: inline-block;margin-left:20%!important;margin-top:-10px!important;padding-left: 5px;"><img
													src="images/Arrow.svg" width="11px"
													style="padding-left:2px; padding-top:2px;" /> <img src="images/Oval.svg"
													width="10px" /></span></p>
									</div>
								</div>
							</div>>
	
							<div class="col-md-4 due-date-section"
								style="float:right;width:33.33%!important;position:relative;">
								...
								<div class="due-date-fine-amount">
									...
									<p style="margin-top:-10px;" class="second-row-of-due-date"><span
											style="padding-right:15px;">DUE DATE </span><span>' . $due_date . '</span></p>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="third-section-of-footer row"
						style="position:relative;  clear:both;display: inline-block;width:100%;">
						...
						<div class="col-md-4 payable-check-info" style="float:left;width:33.33%;position:relative;">
							<p class="main-chq">Make check payable to:<br />
								...
								<span class="chq_address">' . $violation_details['vil_city'] . ', ' .
									$violation_details['vil_state'] . ' ' . $violation_details['vil_zip'] . '</span>
							</p>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12 fourth-section-of-div"
						style="position:relative;  clear:both;display:block; width:100%;">
						<div class="col-md-8 video-and-imginfo payment-intructions"
							style="float:left;width:50%;position:relative; margin-top:-10px;">
	
							<p>SEE VIDEO OR PHOTOS OR PAY BY CREDIT<br />
								CARD NOW AT STOPFORKIDS.COM/PAY <img class="creditcard-img" src="images/card-svg1.svg"
									width="160"
									style="display:inline-block;margin-left:85%!important;margin-top:-20px!important;" />
							</p>
						</div>
					</div>
		...
		foreach ($violations_details as $violation_details) {
			...
			*, *:before, *:after {
			...
			<div class="container" style="background-color:white;">
				<div class="header">
							<div class="row">
									<div class="col-md-12 logoimg"><img class="logo" src="../cms/public/images/villages/' . $violation_details['municipality_logo'] . '" style="padding-left:5px;">
										<p class="automated-stop-sign">STOP SIGN ENFORCEMENT</p>

										<p class="village-of-great-neck">' . $violation_details['municipality_id_text'] . '</p>

										<p class="baker-hill-road">' . $vil_address . '  • ' . $violation_details['vil_city'] . ', ' . $violation_details['vil_state'] . ' ' . $violation_details['vil_zip'] . '</p>
				...
				<div class="row">
						<div class="col-md-4">
							<div class="notice-box">
								<div class="notice">
									...
									<p class="violation-number"><span>Violation Number:</span> ' . $violation_details['violation_number'] . '</p>
					...
					<div class="you-must-pay">
						&nbsp;
						<p class="youmust" style="margin-bottom:1.5%!important;margin-top:2px!important;text-align:center!important;">YOU MUST PAY OR CONTEST BY</p>
						<div class="finedate" >
						
								<p class="date-main">' . date('M d Y', strtotime($violation_details['due_date_new'])) . '<br>
								$' . $violation_details['violation_fine_amount'] . '</p>
			...
			<div class="row">
										...
										<div class="col-md-4 various-payment-methods" style="float:left;width:29%!important;">
											...
											<p class="in-person" style="float:left!important;text-align:left;margin-top:13%!important;"><span>REQUEST IN-PERSON<br />
