        ...
        <div class="card">
            ...
            <div class="body">
                <div class="row clearfix">
                    ...
                    <?php echo form_open_multipart(base_url('admin/villages/add'), 'class="form-horizontal"');  ?>
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-8 col-md-10 col-sm-8 col-xs-7">
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" id="village_court" name="village_court" class="form-control">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-8 col-md-10 col-sm-8 col-xs-7">
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" id="fine_amount" name="fine_amount" class="form-control">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-8 col-md-10 col-sm-8 col-xs-7">
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" id="payable_to" name="payable_to" class="form-control">
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="form-line">
                                    <select class="form-control show-tick" id="state" name="state">
                                        ...
                                        <?php foreach ($states as $state) { ?>
                                            <option <?= ('NY' == $state) ? ' selected="selected"' : ''; ?> value="<?= $state; ?>"><?= $state; ?></option>
                                        <?php
                                        }
                                        ?>
                                    </select>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-8 col-md-10 col-sm-8 col-xs-7">
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" id="stripe_pub_key" name="stripe_pub_key" class="form-control">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-8 col-md-10 col-sm-8 col-xs-7">
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" id="stripe_sec_key" name="stripe_sec_key" class="form-control">
                                </div>
                            </div>
                        </div>
                    </div>
