	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="card">
			<div class="header">
				...
				<div>
					<p>Showing a list of all violations where the payment status is "paid" and the status is not "Archived". DEMO plates are excluded.</p>
				</div>
			</div>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		var table = $('#na_datatable').DataTable({
			"processing": true,
			"serverSide": true,
			"ajax": "<?= base_url('admin/violations/datatable_json_paid') ?>",
			"order": [
				[1, 'asc']
			],
