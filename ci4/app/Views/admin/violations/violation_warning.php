		...
		<div class="card">
			<div class="header">
				<div>
					...
					<a href="<?= base_url('admin/violations/exportallcsv/paid'); ?>" class="btn btn-primary btn-export pull-right">Export All</a>
					<a href="<?= base_url('admin/violations/import/paid'); ?>" class="btn btn-success btn-import pull-right">Import</a>
					<a href="<?= base_url('admin/violations/quick_import/paid'); ?>" class="btn btn-success btn-quick-import pull-right">Quick Import</a> <!-- Shang -->
				...
				<div>
					<p>Showing a list of all violations that are unpaid and not sent (New, Reviewed). DEMO plates are excluded.</p>
				</div>
			</div>
			...
			<div class="body">
				<div class="table-responsive">
					...
					<input type="hidden" id="type" name="type" value="warning" />
					<div>
						<div class="row">
							<div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
								<select id="pdf_template" name="pdf_template">
									...
									<option value="4">Double window Size 10 Envelope - Warning</option>
								</select>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		var table = $('#na_datatable').DataTable({
			"processing": true,
			"serverSide": true,
			"ajax": "<?= base_url('admin/violations/datatable_json_warning') ?>",
			"order": [
				[1, 'asc']
			],
