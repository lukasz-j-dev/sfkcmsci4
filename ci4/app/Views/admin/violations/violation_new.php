		...
		<div class="card">
			<div class="header">
				<div>
					...
					<a href="<?= base_url('admin/violations/exportallcsv/new'); ?>" class="btn btn-primary btn-export pull-right">Export All</a>
					<a href="<?= base_url('admin/violations/import/new'); ?>" class="btn btn-success btn-import pull-right">Import</a>
					<a href="<?= base_url('admin/violations/quick_import/new'); ?>" class="btn btn-success btn-quick-import pull-right">Quick Import</a> <!-- Shang -->
				...
				<div>
					<p>Showing a list of default violations when newly created or imported violations. Plate containing the word DEMO are not shown.</p>
				</div>
			</div>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		var table = $('#na_datatable').DataTable({
			"processing": true,
			"serverSide": true,
			"ajax": "<?= base_url('admin/violations/datatable_json_new') ?>",
			"order": [
				[1, 'asc']
			],
