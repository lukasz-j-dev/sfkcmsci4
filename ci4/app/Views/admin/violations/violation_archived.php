		...
		<div class="card">
			<div class="header">
				<div>
					...
					<a href="<?= base_url('admin/violations/exportallcsv/archived'); ?>" class="btn btn-primary btn-export pull-right">Export All</a>
					<a href="<?= base_url('admin/violations/import/archived'); ?>" class="btn btn-success btn-import pull-right">Import</a>
					<a href="<?= base_url('admin/violations/quick_import/archived'); ?>" class="btn btn-success btn-quick-import pull-right">Quick Import</a> <!-- Shang -->
				...
				<div>
					<p>Showing a list of all violations where the status is "Archived (4)". DEMO plates are excluded.</p>
				</div>
			</div>
			...
			<div class="body">
				<div class="table-responsive">
					...
					<input type="hidden" id="type" name="type" value="archived" />
					<div>
						<div class="row">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		var table = $('#na_datatable').DataTable({
			"processing": true,
			"serverSide": true,
			"ajax": "<?= base_url('admin/violations/datatable_json_archived') ?>",
			"order": [
				[1, 'asc']
			],
