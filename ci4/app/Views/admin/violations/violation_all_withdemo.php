	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="card">
			<div class="header">
				...
				<div>
					<p>Showing a list of all violations where the plate field contains the word DEMO, regardless of the violation status.</p>
				</div>
			</div>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		var table = $('#na_datatable').DataTable({
			"processing": true,
			"serverSide": true,
			"ajax": "<?= base_url('admin/violations/datatable_json_withdemo') ?>",
			"order": [
				[1, 'desc']
			],
			...
			"aoColumnDefs": [{
				...
				{
					"aTargets": [6],
					"sName": "violation_notice_date",
					'bSearchable': false,
					'bSortable': true
				},
				{
					"aTargets": [7],
					"sName": "payment_due_date",
					'bSearchable': true,
					'bSortable': true
				},
				{
