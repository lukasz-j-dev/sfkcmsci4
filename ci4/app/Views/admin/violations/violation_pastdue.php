	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="card">
			<div class="header">
				...
				<div>
					<p>Showing a list of all violations that are unpaid (Mailed, Disputed) and the Due date is 14 days prior to today's date. DEMO plates are excluded.</p>
				</div>
			</div>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		var table = $('#na_datatable').DataTable({
			"processing": true,
			"serverSide": true,
			"ajax": "<?= base_url('admin/violations/datatable_json_pastdue') ?>",
			"order": [
				[1, 'asc']
			],
