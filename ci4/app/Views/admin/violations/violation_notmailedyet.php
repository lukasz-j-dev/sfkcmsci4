		...
		<div class="card">
			<div class="header">
				<div>
					<h2 style="display: inline-block;">
						Violations List(Not mailed yet)
					</h2>
					...
					<a href="<?= base_url('admin/violations/exportallcsv/notmailedyet'); ?>" class="btn btn-primary btn-export pull-right">Export All</a>
					<a href="<?= base_url('admin/violations/import/notmailedyet'); ?>" class="btn btn-success btn-import pull-right">Import</a>
					<a href="<?= base_url('admin/violations/quick_import/notmailedyet'); ?>" class="btn btn-success btn-quick-import pull-right">Quick Import</a> <!-- Shang -->
				...
				<div>
					<p>All violations that have status New (1) and warning period is Not mailed yet</p>
				</div>
			</div>
			...
			<div class="body">
				<div class="table-responsive">
					...
					<input type="hidden" id="type" name="type" value="notmailedyet" />
					<div>
						<div class="row">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		var table = $('#na_datatable').DataTable({
			"processing": true,
			"serverSide": true,
			"ajax": "<?= base_url('admin/violations/datatable_json_notmailedyet') ?>",
			"order": [
				[1, 'desc']
			],
