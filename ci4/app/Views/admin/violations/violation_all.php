		...
		<div class="card">
			<div class="header">
				<div>
					...
					<a href="<?= base_url('admin/violations/exportallcsv/all'); ?>" class="btn btn-primary btn-export pull-right">Export All</a>
					<a href="<?= base_url('admin/violations/import/all'); ?>" class="btn btn-success btn-import pull-right">Import</a>
					<a href="<?= base_url('admin/violations/quick_import/all'); ?>" class="btn btn-success btn-quick-import pull-right">Quick Import</a> <!-- Shang -->
				...
				<div>
					<p>Showing a list of all violations. Violation status "Archived" and Plate containing the word DEMO are not shown.</p>
				</div>
			</div>
