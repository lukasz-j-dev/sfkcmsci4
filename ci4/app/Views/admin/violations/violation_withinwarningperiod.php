		...
		<div class="card">
			<div class="header">
				<div>
					<h2 style="display: inline-block;">
						Violations List(Within warning period)
					</h2>
					...
					<a href="<?= base_url('admin/violations/exportallcsv/withinwarningperiod'); ?>" class="btn btn-primary btn-export pull-right">Export All</a>
					<a href="<?= base_url('admin/violations/import/withinwarningperiod'); ?>" class="btn btn-success btn-import pull-right">Import</a>
					<a href="<?= base_url('admin/violations/quick_import/withinwarningperiod'); ?>" class="btn btn-success btn-quick-import pull-right">Quick Import</a> <!-- Shang -->
				...
				<div>
					<p>All violations that have status New (1) and the warning period is "Within the warning period"</p>
				</div>
			</div>
			...
			<div class="body">
				<div class="table-responsive">
					...
					<input type="hidden" id="type" name="type" value="withinwarningperiod" />
					<div>
						<div class="row">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		var table = $('#na_datatable').DataTable({
			"processing": true,
			"serverSide": true,
			"ajax": "<?= base_url('admin/violations/datatable_json_withinwarningperiod') ?>",
			"order": [
				[1, 'desc']
			],
