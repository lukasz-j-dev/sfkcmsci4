<!-- Range Slider Css -->
<link href="<?= base_url()?>/plugins/ion-rangeslider/css/ion.rangeSlider.css" rel="stylesheet" />
<link href="<?= base_url()?>/plugins/ion-rangeslider/css/ion.rangeSlider.skinFlat.css" rel="stylesheet" />
    ...
    <script src="<?= base_url()?>/plugins/ion-rangeslider/js/ion.rangeSlider.js"></script>
    <!-- Custom Js -->
    <script src="<?= base_url()?>/js/pages/ui/range-sliders.js"></script>