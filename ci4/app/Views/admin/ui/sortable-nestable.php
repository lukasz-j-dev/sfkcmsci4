 <!-- JQuery Nestable Css -->
<link href="<?= base_url()?>/plugins/nestable/jquery-nestable.css" rel="stylesheet" />
...
<!-- Jquery Nestable -->
<script src="<?= base_url()?>/plugins/nestable/jquery.nestable.js"></script>
<!-- Custom Js -->
<script src="<?= base_url()?>/js/pages/ui/sortable-nestable.js"></script>
